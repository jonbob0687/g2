...
pin_number kI2C_SDAPinNumber = -1; //jg added was 20
pin_number kI2C_SCLPinNumber = 21;

pin_number kI2C0_SDAPinNumber = -1; //jg added was 20
...
pin_number kDebug1_PinNumber = -1;// added - jg
//pin_number kDebug2_PinNumber = 47;
pin_number kDebug2_PinNumber = -1; // added - jg
//pin_number kDebug3_PinNumber = 45;
pin_number kDebug3_PinNumber = -1; // added - jg
pin_number kDebug4_PinNumber = -1;

//pin_number kKinen_SyncPinNumber = 53;
pin_number kKinen_SyncPinNumber = -1;// add-jg
...
pin_number kInput12_PinNumber = -1;// added - jg
...
//pin_number kInterlock_InPinNumber  = 48;  // added - jg
...
pin_number kOutput1_PinNumber = 53;  // DO_1: Extruder1_PWM
pin_number kOutput2_PinNumber = 51;  // DO_2: Extruder2_PWM
pin_number kOutput3_PinNumber = 49;  // DO_3: Fan1A_PWM
pin_number kOutput4_PinNumber = 47;  // DO_4: Fan1B_PWM
pin_number kOutput5_PinNumber = 45;  // DO_5: Fan2A_PWM

pin_number kOutput6_PinNumber  = 43;  // 135;     // See Spindle Enable
pin_number kOutput7_PinNumber  = 41;  // 136;     // See Spindle Direction
pin_number kOutput8_PinNumber  = 39;  // 137;     // See Coolant Enable
